...
```{r Cluster analsyis: MCA/k-means method, warning=FALSE, message=FALSE, cache=TRUE}
...
# statistics calculations for categorical variables by SCTDs group
...
```{r Table of distribution of variables within disease groups, echo=FALSE, message=FALSE, results='hide', warning=FALSE}
...
![</br>**Table. Distribution of variables **</br>](./Cluster_Analysis_files/Table_of_distribution_of_variables.png)
<br/>
...
![</br>**Figure 2**</br>](./Cluster_Analysis_files/Cluster_profile/clustering_results_and_cluster_content_profile.jpeg)
...
![</br>**Figure 3**</br>](./Cluster_Analysis_files/Cluster_profile/immunomarker_profile.jpeg)
