...
save_as_image(table_one_flextable,
              path = "./Cluster_Analysis_files/Table_of_distribution_of_variables.pdf",
              expand = 20,
              zoom = 1,
              webshot = "webshot")
...
ggexport(concatenated_clustering_results_plot,
         filename = paste0("./Cluster_Analysis_files/Cluster_profile/",
                           ...
                           ".pdf"),
         # width = 12000,height = 8000,res = 1000,verbose = FALSE) # for jpeg
         width = 11, height = 8.5 ,verbose = FALSE) # for pdf
...
concatenated_immunomarkers_profile_plot <- 
  ggarrange(ggarrange(profile_status_by_item_roseplot,
            ...
            nrow = 2,
            ncol = 1) +
  theme(plot.margin = margin(2.5,.5,.5,.5, "cm")) 

ggexport(concatenated_immunomarkers_profile_plot,
         filename = paste0("./Cluster_Analysis_files/Cluster_profile/",
                           "immunomarker_profile",
                           ".pdf"),
         # width = 20000,height = 16000,res = 1200,verbose = FALSE) # for jpeg
         width = 20,height = 16,verbose = FALSE) # for pdf
