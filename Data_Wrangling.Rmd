...
```{r Clean raw results and merge reference information, message=FALSE, warning=FALSE}
...
```{r within-seven-day exam result merging, eval=TRUE, cache=TRUE}
...
![</br>**Figure 1**</br>](./Data_Wrangling_files/Figure 1. Eligibility and the number of study subjects.jpeg)
